  ...
  >
    <q-scroll-area class="fit">
      <q-list padding class="rounded-borders">
        ...
        <q-expansion-item icon="person" :content-inset-level="0.5" label="會員">
          <q-list padding separator>
            <q-item to="/admin/member/index" clickable v-ripple>
        ...
        <q-expansion-item icon="event" :content-inset-level="0.5" label="活動">
          <q-list padding separator>
        ...
        <q-item to="/admin/user" v-if="can('setting')" clickable v-ripple>
          <q-item-section avatar>
            <q-icon name="manage_accounts" />
          </q-item-section>
          <q-item-section>職員</q-item-section>
        ...
        <q-item to="/admin/media" v-if="can('setting')" clickable v-ripple>
          <q-item-section avatar>
            <q-icon name="image" />
          </q-item-section>
