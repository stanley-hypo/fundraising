...
export default {
    ...
    checkUnique(credentials) {
        return axios
            .post(
                import.meta.env.VITE_APP_URL + "adminapi/checkUnique",
                credentials
            )
    ...
    register(credentials) {
        return axios
            .post(
                import.meta.env.VITE_APP_URL + "adminapi/register",
                credentials
            )
            .then((response) => response.data)
    ...
    update(credentials) {
        return axios
            .post(
                import.meta.env.VITE_APP_URL + "adminapi/user/update",
                credentials
            )
            .then((response) => response.data)
            .catch(function (error) {
    ...
    updatepwd(credentials) {
        return axios
            .post(
                import.meta.env.VITE_APP_URL + "adminapi/user/updatepwd",
                credentials
            )
            .then((response) => response.data)
            .catch(function (error) {
    ...
    getRoleDetail(credentials) {
        return axios
            .post(
                import.meta.env.VITE_APP_URL + "adminapi/role/show",
                credentials
            )
            .then((response) => response.data)
            .catch(function (error) {
    ...
    updateSetting(credentials) {
        ...
        return axios
            .post(
                import.meta.env.VITE_APP_URL + "adminapi/settings/update",
                credentials,
                config
            )
            .then((response) => response.data)
