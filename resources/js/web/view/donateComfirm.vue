      ...
      "
        ...
        <div class="flex justify-center">
            ...
            <div class="leading-loose grid grid-cols-2 gap-4 break-words sm:grid-cols-5">
                ...
                <p class="pl-4 col-start-2 col-span-1 sm:col-start-2 col-span-4">{{formData.donationType}}</p>
            ...
            <div class="leading-loose grid grid-cols-2 gap-4 break-words sm:grid-cols-5">
                ...
                <p class="pl-4 col-start-2 sm:col-start-2 col-span-6">{{ formData.title }}.&nbsp;{{ formData.fullname }}</p>
